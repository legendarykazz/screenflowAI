...
function updateProject(id, fields) {
  ...
  const allowedSettingsFields = [
    ...
    'media_library', 'track_states', 'timeline_snap_enabled', 'ripple_delete_enabled', 'editor_model_version',
    'voice_cleanup_enabled', 'voice_isolation', 'voice_gain', 'normalize_audio',
    'color_preset', 'color_exposure', 'color_contrast', 'color_saturation', 'color_temperature', 'color_tint',
